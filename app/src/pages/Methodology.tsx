      ...
      <div className="min-w-0 space-y-9">
        ...
        <Topic id="tools" title="Tools">
          ...
          <div className="mt-4 space-y-3">
            ...
            <ToolExplanation to="/deck-analysis" name="Deck Calculators" does="Open a directory of focused calculators for card access, functional hands, pacing, resource timing, resilience, testing, and saved sideboard plans." evidence="The deck you load, card details, player classifications, locally recorded games, and probability or timing calculations." limit="These are model-based measurements under stated assumptions, not recommendations or simulated match outcomes." />
            ...
            <ToolExplanation to="/looking-for" name="Trading Binder" does="Publish selected available cards, track wants, find reciprocal matches, and manage versioned trade offers." evidence="The binder quantities you explicitly publish, your printing-aware collection, and both traders’ recorded offer actions." limit="Fan of Insight does not verify card condition, shipping, identity, payment, or fulfillment; use the dispute action as an audit signal, not a platform guarantee." />
          </div>
