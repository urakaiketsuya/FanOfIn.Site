...
const NAV_ENTRIES: NavEntry[] = [
  ...
  { kind: "group", label: "Tools", paths: ["/compare", "/deck-builder", "/deck-analysis", "/deck-review", "/goldfish", "/card-discovery", "/looking-for"], links: [{ to: "/compare", label: "Compare Decks" }, { to: "/deck-builder", label: "Deck Builder" }, { to: "/deck-analysis", label: "Deck Analysis" }, { to: "/deck-review", label: "Deck Review" }, { to: "/goldfish", label: "Goldfish Test" }, { to: "/card-discovery", label: "Find New Cards" }, { to: "/looking-for", label: "Looking For" }] },
