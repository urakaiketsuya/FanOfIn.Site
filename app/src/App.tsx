...
const NAV_GROUPS = [
  { label: "Explore", paths: ["/cards", "/champions", "/archetypes", "/decks", "/official-decks", "/pantheon"], links: [{ to: "/cards/stats", label: "Card Stats" }, { to: "/cards/packages", label: "Card Packages" }, { to: "/cards?tab=sets", label: "Sets" }, { to: "/champions", label: "Champions" }, { to: "/archetypes", label: "Archetypes" }, { to: "/decks", label: "Browse Decks" }, { to: "/pantheon", label: "Pantheon" }, { to: "/official-decks", label: "Official Product Decks" }] },
