...
const NAV_ENTRIES: NavEntry[] = [
  ...
  { kind: "group", label: "Decks", paths: ["/decks", "/pantheon/decks"], links: [{ to: "/decks", label: "Tournament Decks" }, { to: "/pantheon/decks", label: "Pantheon Decks" }, { to: "/decks/shared", label: "Shared Decks" }] },
  ...
  { kind: "group", label: "Tools", paths: ["/compare", "/deck-builder", "/deck-analysis", "/deck-review", "/combo-lab", "/goldfish", "/match-log", "/card-discovery", "/looking-for"], links: [{ to: "/compare", label: "Compare Decks" }, { to: "/deck-builder", label: "Deck Builder" }, { to: "/deck-analysis", label: "Deck Calculators" }, { to: "/deck-review", label: "Deck Review" }, { to: "/combo-lab", label: "Combo Lab" }, { to: "/goldfish", label: "Goldfish Test" }, { to: "/match-log", label: "Match Log" }, { to: "/card-discovery", label: "Find New Cards" }, { to: "/looking-for", label: "Trading Binder" }] },
