...
const NAV_GROUPS = [
  { label: "Explore", paths: ["/cards", "/champions", "/archetypes", "/decks", "/official-decks"], links: [{ to: "/cards/stats", label: "Card Stats" }, { to: "/cards?tab=sets", label: "Sets" }, { to: "/champions", label: "Champions" }, { to: "/archetypes", label: "Archetypes" }, { to: "/decks", label: "Browse Decks" }, { to: "/official-decks", label: "Official Product Decks" }] },
