...
const NAV_GROUPS: NavGroup[] = [
  ...
  { label: "More", paths: ["/achievements", "/changelog", "/media-kit", "/settings"], links: [{ to: "/achievements", label: "Achievements" }, { to: "/media-kit", label: "Media Kit" }, { to: "/changelog", label: "Changelog" }, { to: "/settings", label: "Display Settings" }] },
];
