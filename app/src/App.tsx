...
const NAV_GROUPS: NavGroup[] = [
  ...
  { label: "Decks", paths: ["/decks", "/decklists", "/shared-decks", "/community-decks", "/users", "/my-decks", "/deck-builder", "/official-decks", "/pantheon"], links: [{ to: "/decks", label: "Tournament Decks" }, { to: "/shared-decks", label: "Community Decks" }, { to: "/my-decks", label: "My Decks" }, { to: "/deck-builder", label: "Deck Builder" }, { to: "/official-decks", label: "Official Decks" }, { to: "/pantheon", label: "Pantheon Decks" }, { to: "/community-decks", label: "Deck Trends" }] },
  ...
  { label: "More", paths: ["/achievements", "/changelog", "/simulator", "/diao-review", "/media-kit", "/regions", "/looking-for"], links: [{ to: "/looking-for", label: "Looking For" }, { to: "/regions", label: "Regional Analysis" }, { to: "/achievements", label: "Achievements" }, { to: "/simulator", label: "Simulator" }, { to: "/diao-review", label: "DIAO Score Review" }, { to: "/media-kit", label: "Media Kit" }, { to: "/changelog", label: "Changelog" }] },
];
