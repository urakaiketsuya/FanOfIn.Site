...
const NAV_GROUPS = [
  { label: "Explore", paths: ["/cards", "/champions", "/archetypes", "/decks", "/shared-decks", "/users", "/official-decks", "/pantheon"], links: [{ to: "/cards/stats", label: "Card Stats" }, { to: "/cards/packages", label: "Card Packages" }, { to: "/cards?tab=sets", label: "Sets" }, { to: "/champions", label: "Champions" }, { to: "/archetypes", label: "Archetypes" }, { to: "/decks", label: "Browse Decks" }, { to: "/shared-decks", label: "Shared Decks" }, { to: "/pantheon", label: "Pantheon" }, { to: "/official-decks", label: "Official Product Decks" }] },
  ...
  { label: "Tools", paths: ["/compare", "/deck-builder", "/my-decks", "/account", "/regions", "/looking-for"], links: [{ to: "/my-decks", label: "My Decks" }, { to: "/account", label: "Account" }, { to: "/compare", label: "Compare Decks" }, { to: "/deck-builder", label: "Guided Deck Builder" }, { to: "/looking-for", label: "Looking For" }, { to: "/regions", label: "Regional Analysis" }] },
  { label: "More", paths: ["/achievements", "/community-decks", "/packs", "/changelog", "/simulator", "/diao-review", "/media-kit"], links: [{ to: "/achievements", label: "Achievements" }, { to: "/community-decks", label: "Community Decks" }, { to: "/simulator", label: "Simulator Data (Experimental)" }, { to: "/diao-review", label: "DIAO Score Review" }, { to: "/media-kit", label: "Media Kit" }, { to: "/changelog", label: "Changelog" }] },
];
