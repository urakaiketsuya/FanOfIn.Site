...
const NAV_GROUPS: NavGroup[] = [
  ...
  { label: "Decks", paths: ["/decks", "/decklists", "/shared-decks", "/community-decks", "/users", "/my-decks", "/official-decks", "/pantheon"], links: [{ to: "/decks", label: "Tournament Decks" }, { to: "/shared-decks", label: "Community Decks" }, { to: "/my-decks", label: "My Decks" }, { to: "/official-decks", label: "Official Decks" }, { to: "/pantheon", label: "Pantheon Decks" }, { to: "/community-decks", label: "Deck Trends" }] },
  ...
  { label: "Tools", paths: ["/compare", "/deck-builder", "/looking-for", "/regions", "/simulator", "/diao-review"], links: [{ to: "/compare", label: "Compare Decks" }, { to: "/deck-builder", label: "Deck Builder" }, { to: "/looking-for", label: "Looking For" }, { to: "/regions", label: "Regional Analysis" }, { to: "/simulator", label: "Simulator" }, { to: "/diao-review", label: "DIAO Score Review" }] },
  { label: "More", paths: ["/achievements", "/changelog", "/media-kit"], links: [{ to: "/achievements", label: "Achievements" }, { to: "/media-kit", label: "Media Kit" }, { to: "/changelog", label: "Changelog" }] },
];
