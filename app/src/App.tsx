...
const NAV_GROUPS = [
  ...
  { label: "Tools", paths: ["/compare", "/deck-builder", "/my-decks", "/regions", "/looking-for"], links: [{ to: "/my-decks", label: "My Decks" }, { to: "/compare", label: "Compare Decks" }, { to: "/deck-builder", label: "Guided Deck Builder" }, { to: "/looking-for", label: "Looking For" }, { to: "/regions", label: "Regional Analysis" }] },
