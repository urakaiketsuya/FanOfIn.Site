...
const NAV_GROUPS = [
  { label: "Explore", paths: ["/cards", "/champions", "/archetypes", "/decks", "/official-decks", "/pantheon"], links: [{ to: "/cards/stats", label: "Card Stats" }, { to: "/cards?tab=sets", label: "Sets" }, { to: "/champions", label: "Champions" }, { to: "/archetypes", label: "Archetypes" }, { to: "/decks", label: "Browse Decks" }, { to: "/pantheon", label: "Pantheon" }, { to: "/official-decks", label: "Official Product Decks" }] },
  ...
  { label: "Tools", paths: ["/compare", "/deck-builder", "/regions", "/looking-for"], links: [{ to: "/compare", label: "Compare Decks" }, { to: "/deck-builder", label: "Guided Deck Builder" }, { to: "/looking-for", label: "Looking For" }, { to: "/regions", label: "Regional Analysis" }] },
  { label: "More", paths: ["/achievements", "/community-decks", "/packs", "/changelog", "/simulator", "/media-kit"], links: [{ to: "/achievements", label: "Achievements" }, { to: "/community-decks", label: "Community Decks" }, { to: "/simulator", label: "Simulator Data (Experimental)" }, { to: "/media-kit", label: "Media Kit" }, { to: "/changelog", label: "Changelog" }] },
];
