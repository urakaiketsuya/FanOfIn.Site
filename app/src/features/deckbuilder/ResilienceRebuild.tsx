...
type Role = "establish" | "protection" | "rebuild";
const LABEL: Record<Role, string> = { establish: "Establish", protection: "Protect", rebuild: "Rebuild" };
const percent = (value: number) => `${(value * 100).toFixed(1)}%`;

export default function ResilienceRebuild({ mainLines, materialLines, catalogByName }: { mainLines: Line[]; materialLines: Line[]; catalogByName: Map<string, Card> }) {
