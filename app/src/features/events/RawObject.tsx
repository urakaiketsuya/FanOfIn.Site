...
export default function RawObject({ data }: { data: unknown }) {
  if (data === null || typeof data !== "object") {
    return <p data-component="RawObject" className="text-sm text-ctp-subtext1">{String(data)}</p>;
  }

  return (
    <dl data-component="RawObject" className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-1 text-sm">
