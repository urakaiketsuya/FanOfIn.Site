...
export default function UserDecklistPanel({ decklist, actions, children, ownerDeckId }: { decklist: OmnidexDecklist; actions?: ReactNode; children?: ReactNode; ownerDeckId?: string }) {
