...
export default function ImportDecksPanel({ decks, busy, run, onImported, onClose }: {
  ...
  return <section className="mt-6 rounded-xl border border-ctp-blue/40 bg-ctp-mantle p-4 sm:p-5">
