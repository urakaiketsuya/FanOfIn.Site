...
export default function DeckAnalysisIndex() {
  ...
  return <PageLayout>
    ...
    {tab === "explore" && <div className="mt-4 space-y-3">
      ...
      <AnalysisDisclosure title="Draw quality by game stage" summary="Measure early setup, later impact, and stage-specific clunk using prepared roles as a starting point."><StageDrawQuality mainLines={workspace.main} materialLines={workspace.material} catalogByName={catalogByName} sharedAssignments={analysisRoles} /></AnalysisDisclosure>
