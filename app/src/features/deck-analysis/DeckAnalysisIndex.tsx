...
const CALCULATORS = ["Game plan readiness", "Opening hand recipe", "Level-up runway", "Pressure continuity", "Engine-to-payoff balance", "Interaction coverage", "Resilience and rebuild", "Test session tracker", "Draw quality by game stage", "Post-sideboard plan", "Card access and probability", "Clumping and conditional pressure", "Resource timing", "Advanced sequence analysis"];
