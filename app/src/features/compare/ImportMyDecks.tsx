...
export default function ImportMyDecks({ comparedKeys, onToggle }: { comparedKeys: Set<string>; onToggle: (deck: ComparedDeck) => void }) {
  ...
  if (state === "error") return <InlineState tone="danger">Your deck library could not be loaded.</InlineState>;
  ...
  return <div data-component="ImportMyDecks">
    ...
    {decks.length === 0 ? <InlineState className="mt-3">No decks match this search.</InlineState> : <div className="mt-3 grid gap-2 sm:grid-cols-2">
